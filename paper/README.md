...
Anpassen müssen Sie die folgenden Dateien
  ...
  * `paper.tex` - Hauptdokument. Hier müssen Sie Ihren Text hineinschreiben.
 ...
 * Wählen Sie das Overleaf Logo oben links, um das Einstellungsmenue aufzurufen und stellen Sie die Option "Main document" auf `paper.tex`
 * Wählen Sie nun in der Dateiliste ebenfalls `paper.tex`
...
[Texmaker](https://www.xm1math.net/texmaker/) unterstützt alle Betriebssysteme.
  ...
  * Öffnen Sie die Datei `paper.tex` mit Texmaker
...
Ab der Version 2 von TexnicCenter wird das UTF-8-Format richtig unterstützt.
  ...
  * Öffnen Sie die Datei `paper.tex` mit TexnicCenter
